...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lighthouse = function () {
	  function Lighthouse(token) {
	    ...
	    var cid = (0, _utils.getParameterByName)(CID_KEY);
	    var pid = (0, _utils.getParameterByName)(PID_KEY);
	    var target = (0, _utils.getParameterByName)(TARGET_KEY);
	  ...
	  */
	  ...
	  (0, _createClass3.default)(Lighthouse, [{
	    key: 'sendRequest',
	    value: function sendRequest(data, callback) {
	      ...
	      var successBlock = function successBlock(responseData) {
	        // Got some data
	        if (callback) {
	          var error = responseData !== '1' ? new Error('Lighthouse Server Error') : undefined;
	          callback(error);
	        }
	      };

	      var errorBlock = function errorBlock(error) {
	      ...
	      }).then(successBlock).catch(errorBlock);
	    }
	  }, {
	    key: 'mergeObject',
	    ...
	    key: 'register',
	    value: function register(properties) {
	      this.properties = this.properties || {};
	      this.mergeObject(this.properties, properties);
	    }
	  }, {
	    key: 'identify',
	    value: function identify(uid) {
	    ...
	    key: 'registerSocial',
	    value: function registerSocial(openid, service) {
	    ...
	    key: 'getShareLink',
	    value: function getShareLink(link) {
	      var openid = this.properties.openid;
	      var cid = this.properties.__cid__;
	      var target = this.properties.target;

	      var share = link || location.href;

	      share = (0, _utils.removeURLParameter)(share, 'code');
	      share = (0, _utils.removeURLParameter)(share, 'state');
	      share = (0, _utils.removeURLParameter)(share, CID_KEY);
	      share = (0, _utils.removeURLParameter)(share, PID_KEY);
	      share = (0, _utils.removeURLParameter)(share, TARGET_KEY);
	      share = share.split('#')[0] + '&' + CID_KEY + '=' + openid + '&' + PID_KEY + '=' + cid + '&' + TARGET_KEY + '=' + target;
	    ...
	    */
	    ...
	    key: 'track',
	    value: function track(event, properties, callback) {
	      this.properties = this.properties || {};
	      var newProperties = properties || {};
	      newProperties.time = (0, _utils.getUnixtime)();

	      var mergedProperties = JSON.parse(JSON.stringify(this.properties));
	      ...
	      // transfer to base64
	      var eventData = new Buffer(JSON.stringify(data)).toString('base64');
	    ...
	    */
	    ...
	    key: 'trackLinks',
	    value: function trackLinks(query, event, properties) {
	      var _this2 = this;

	      var els = Array.prototype.slice.call(document.querySelectorAll(query), 0);
	      els.forEach(function (el) {
	        el.removeEventListener();
	        el.addEventListener(EVENT_CLICK, function () {
	          return _this2.track(event, properties);
	        });
	      });
	    }
...
/***/ function(module, exports) {
	...
	function generateUUID() {
	  ...
	  var uuidFormatString = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx';
	  var uuid = uuidFormatString.replace(/[xy]/g, function (char) {
	    var randNumber = (date + Math.random() * 16) % 16 | 0;
